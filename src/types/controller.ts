...
import { Get } from '../components/router';
...
interface setRouters<
    Model = MongoModel<Document>,
    OriginalRouters extends ControllerRouters = ControllerRouters,
    NewRouters extends ControllerRouters = ControllerRouters
> {
    (routers: NewRouters | { (options: ControllerOptions): NewRouters }): Controller<Model, NewRouters>;
}
